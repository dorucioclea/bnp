...
export default class LoginPage extends React.Component {
  ...
  handleLanguageSelect = language => this.setState({ language });
  ...
  handleLoginClick = () => {
    ...
    this.context.authenticationService.login({
      ...
      catch(errStatus => this.ignoreAjax || this.setState(
        errStatus === 503 ?
        {
        ...
        >
          <div className="container-fluid">
            <div className="navbar-header">
              ...
              >
                Welcome to OpusCapita<br/> Business Network Portal
              </p>
            </div>
            ...
            >
              <div className="row">
                ...
                <div className="col-md-4">
                  ...
                  <br/>
                  <p>
                    OpusCapita Business Network integrates buyers, suppliers and other business partners in an
                    efficient way. You can automate sending and receiving all types of electronic business documents,
                    including e-invoices globally, through this network.
                  </p>
                </div>
              </div>
            </div>
