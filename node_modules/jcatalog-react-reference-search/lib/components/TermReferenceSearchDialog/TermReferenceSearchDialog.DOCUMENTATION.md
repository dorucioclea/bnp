...
| onCloseDialog | func (required) | Callback fired on dialog closing |
| onBlur | func | Callback fired when the component loose focus |
| openDialog | bool (required) | Is dialog opened |
