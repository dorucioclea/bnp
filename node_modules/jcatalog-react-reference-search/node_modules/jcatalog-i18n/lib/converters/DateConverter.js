...
var DateConverter = function (_Converter) {
  ...
  function DateConverter(format, locale) {
    _classCallCheck(this, DateConverter);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DateConverter).call(this));

    _this.momentFormat = (0, _moment2.default)().toMomentFormatString(format);
    _this.locale = locale;
    return _this;
  }
